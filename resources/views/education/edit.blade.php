...
<section class="w3-padding">
    ...
    <form method="post" action="/console/education/edit/{{$education->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="institution_name" name="institution_name" id="institution_name" value="{{old('institution_name', $education->institution_name)}}" required>
        ...
        <div class="w3-margin-bottom">
			...
			<select name="degree_type" id="degree_type">
				...
				@foreach($degree_types as $degree_type)
					@if ($degree_type == $education->degree_type)
        ...
        <div class="w3-margin-bottom">
			...
			<select name="start_month" id="start_month">
				@foreach($months as $month)
					@if (old('start_month',$education->start_month) == strtolower($month))
        ...
        <div class="w3-margin-bottom">
			...
			<input type="text" name="start_year" id="start_year" pattern="\d{4}" value="{{old('start_year', $education->start_year)}}">
        ...
        <div class="w3-margin-bottom">
			...
			<select name="end_month" id="end_month">
				@foreach($months as $month)
					@if (old('end_month',$education->end_month) == strtolower($month))
				  		<option value="{{strtolower($month)}}" selected>{{ $month }}</option>
				  	@else
				  		<option value="{{strtolower($month)}}">{{ $month }}</option>
				  	@endif
        ...
        <div class="w3-margin-bottom">
			...
			<input type="text" name="end_year" id="end_year" pattern="\d{4}" value="{{old('end_year',$education->end_year)}}">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="slug" id="slug" value="{{old('slug', $education->slug)}}" required>
